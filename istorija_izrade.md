...
- **Opis:**
  ...
  1. **Migracija Wav2Lip na Modal:** Prebacili smo tešku Wav2Lip inferenciju sa lokalnog VPS-a na serverless Modal GPU worker ([modal_workers/wav2lip_worker.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/modal_workers/wav2lip_worker.py)) koji koristi NVIDIA T4 GPU i podržava preuzimanje check-pointa na NFS deljeno skladište (`sinhronizuj-models-nfs`).
  2. **Asinhrone Modal pozivnice:** Unapredili smo klijentsku logiku u [backend/worker/utils.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/backend/worker/utils.py) da se dugotrajni Modal pozivi (poput prevođenja, transkripcije, sinteze, lipsync) pozivaju asinhrono (polling model preko `/submit` i `/status/{job_id}`) sa ugrađenim automatskim fallback-om na sinhroni režim za unazadnu kompatibilnost. Integrisali smo Modal u [backend/worker/lipsync.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/backend/worker/lipsync.py) i za puni i za selektivni LipSync.
  3. **Migracija storage-a (Hetzner S3 i Cloudflare R2):** Omogućili smo laku konfiguraciju za prelazak sa lokalnog MinIO-a na bilo koji S3 kompatibilni provajder (Hetzner S3, Cloudflare R2 ili AWS) kroz `STORAGE_PROVIDER` i `S3_` konfiguracione parametre u [backend/core/config.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/backend/core/config.py) i zamenili hardkodovane us-east-1 regione u S3 klijentima sa dinamičkim `settings.S3_REGION`.
  4. **Kvote i limiti:** Implementirali smo bezbednosne provere i limite na nivou API-ja u ruti `/api/v1/process-video` u [backend/main.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/backend/main.py). Ograničili smo maksimalnu veličinu pojedinačnog fajla (`MAX_SINGLE_FILE_SIZE_MB`), ukupnu dnevnu veličinu upload-a (`MAX_DAILY_UPLOAD_MB`) i ukupno dnevno trajanje obrade videa (`MAX_DAILY_DURATION_SEC`) po korisniku, koristeći Redis za praćenje i ffprobe za brzo čitanje metapodataka o trajanju.
  5. **Kalkulator troškova:** Integrisali smo precizni blended cost model na osnovu stvarnog GPU vremena i resursa. Ažurirali smo `add_phase_cost` u [backend/worker/tasks.py](file:///home/gruya/.gemini/antigravity/brain/bf11e4db-91f7-4c6e-a67c-cd38dff657a5/.system_generated/worktrees/subagent-Scalability-and-Cost-Engineer-ScalabilityCostAgent-38bd1e4c/backend/worker/tasks.py) da se za LipSync na Modalu automatski računa stvarna stopa od `$0.00018 / s` za T4 GPU, dok lokalni fallback ima cenu `$0.0 / s`.
