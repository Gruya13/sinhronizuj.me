# Veštačka Inteligencija i Modal Radnici
...
3.  **Fleksibilan izbor GPU hardvera**: Moguće je definisati tačan tip GPU-a za svaki pojedinačni zadatak (od Nvidia T4 do moćnih L4 i A10G kartica).
...
*   **Funkcija**: Prihvata audio traku i vrši razdvajanje na čiste vokale (`vocals`) i prateću matricu (`no_vocals`). Vidi [[Audio_i_Video_Procesiranje]].
...
3.  **Spremnost**: Kada korisnik završi sa unosom videa ili klikne na generisanje audia, Modal kontejneri su već podignuti i spremni ("warm"), te izvršavaju zadatke u realnom vremenu.
