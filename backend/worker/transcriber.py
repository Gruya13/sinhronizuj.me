...
def arbitrate_transcripts(whisper_segments: list, sensevoice_text: str) -> list:
    ...
    for i, seg in enumerate(whisper_segments):
        whisper_input += f"{i}|{seg['text']}\n"
        
    arbitration_prompt = (
        "You are an expert English audio transcript editor.\n"
        "I will provide you with two things:\n"
        "1. A list of numbered text segments generated by Whisper ASR (which has word timestamps but might have misheard or missing words).\n"
        ...
        "1. Output exactly one line per segment in the format: ID|Corrected text\n"
        f"2. You must output exactly {len(whisper_segments)} lines (from 0 to {len(whisper_segments)-1}).\n"
        "3. Do not include any introduction, explanation, or code blocks. Just the ID|text lines.\n\n"
